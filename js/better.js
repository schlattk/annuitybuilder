...
$.ajax({
    ...
    success: function (data) {
       ...
       // instrument_name.splice(0,8);
        var instr_length =instrument_name.length;
...
faq.addEventListener("click", function(event){
  ...
  function findCashFlows(treasury, UkGilts){
    ...
    var treasurylist = [];
    var treasuryLength, couponFlowNewList, treasuryListLength, exception, missingDates, accruedPrice,
        notionalFlowNewList, totalFlowNewList, totalFlowListLength, costofbonds, notionalFlowNewList,
        couponFlowNewList, adjustment2, averageFlows, better, betterData, Betterchart, notionalPrice,
